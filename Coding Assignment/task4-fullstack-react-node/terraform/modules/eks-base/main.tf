# --------------------------------------------------------------------------
# Reusable module: VPC + EKS + one ECR repo per service.
# Both frontend and backend share the SAME cluster (shared infra, task
# requirement) but get their own ECR repos so image lifecycles stay separate.
# --------------------------------------------------------------------------
